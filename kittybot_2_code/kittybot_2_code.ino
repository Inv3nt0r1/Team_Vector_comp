...
void setup() 
{
  ...
  { // Centre all values and the output to the serovs
...
void servomove() 
{
  ...
  { // Loop continues until the time step is fulfilled
    for (int i = 0; i < servonum; i++) 
  ...
  for (int i = 0; i < servonum; i++) 
  { // Make on last iteration to assure that the servos reached their end positions
