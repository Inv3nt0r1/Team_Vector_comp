...
// Set gyroscope full scale range
 ...
 // but all these rates are further reduced by a factor of 5 to 200 Hz because of the SMPLRT_DIV setting
  ...
  // Set interrupt pin active high, push-pull, hold  pin level HIGH until interrupt cleared,
...
//-------------------------------------------------------------------
 ...
 intPin = 20;  // These can be changed, 2 and 3 are the Arduinos ext int pins
 adoPin = 8;
 myLed = 13;
   ...
   // Print temperature in degrees Centigrade      
    ...
    if(SerialDebug) 
    {
     yawfromfunc = getangle(getyaw);
      rollfromfunc = getangle(getroll);
      pitchfromfunc = getangle(getpitch);
    }
    count = millis(); 
    sumCount = 0;
    sum = 0;    
